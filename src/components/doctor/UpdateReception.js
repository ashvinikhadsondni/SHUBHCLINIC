...
import { newRecpReducer } from "../../reduxData/ReceptionSlice"
export default function UpdateReception() {
    const user = useSelector(state => state.authInfo.value)
    const recpData = useSelector(state => state.recpInfo.upData)
        ...
        <section id="appointment" className="appointment section-bg " style={{ marginTop: "80px" }}>
            <div className="container">
                ...
                <div className="section-title">
                    <h2>Updating Record of MR/MISS {recpData.name}</h2>
                    <p>{msg}</p>
                </div>
