            ...
            <div className="container">
                ...
                <form onSubmit={save} className="php-email-form">
                    <div className="row">
                        ...
                        <div className="col-md-4 form-group mt-md-0">
                            <label>Age</label>
                            <input ref={ageBox} type="number" name="age" className="form-control" id="age" placeholder="Your Age" />
                        </div>
                        <div className="col-md-4 form-group mt-md-0">
                            <label>Gender</label>
                            <select ref={genBox} name="gender" className="form-control form-select" id="raddress"  >
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-4 form-group mt-3 mt-md-0">
                            ...
                            <input ref={dateBox} type="date" className="form-control" name="date" id="date" />
                        </div>
                        <div className="col-md-4 form-group mt-3 mt-md-0">
                            <label>Time</label>
                            <input ref={timeBox} type="time" className="form-control" name="time" id="time" />
                        </div>
                    </div>
